...
export const metadata: Metadata = {
  title: "Let's F*ck Around and Find Out - Travel Adventures",
  description: "Join unscripted global adventures with no plans, just pure exploration. Watch weekly episodes of authentic travel moments.",
  keywords: "travel vlog, adventure travel, unscripted travel, travel show, exploration",
  metadataBase: new URL('https://letsfuckaroundandfindout.com'),
  alternates: {
    canonical: 'https://letsfuckaroundandfindout.com'
  },
  openGraph: {
    title: "Let's F*ck Around and Find Out",
    description: "Unscripted adventures across the globe. No plans, no limits, just pure exploration.",
    url: "https://letsfuckaroundandfindout.com",
    siteName: "Let's F*ck Around and Find Out",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SiMkwDFagCJqdtr8SgryeO9Cj/uploaded-1765890682623-xcxkcxik.jpg",
      alt: "Travel Adventure Show"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Let's F*ck Around and Find Out",
    description: "Unscripted global travel adventures",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SiMkwDFagCJqdtr8SgryeO9Cj/uploaded-1765890682623-xcxkcxik.jpg"]
  },
  robots: {
    index: true,
    follow: true
